    ...
    <el-card class="home-card">
      <template #header>
        <div class="card-header">
          <h2>{{ $t('INFRA_HOME_WELCOME', '欢迎使用基础设施管理') }}</h2>
      ...
      <div v-else class="empty-routes">
        <el-empty :description="$t('INFRA_HOME_NO_ENTRY', '暂无可用功能入口')" :image-size="100" />
      </div>
    </el-card>
  </div>
</template>
